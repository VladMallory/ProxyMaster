...
func main() {
	...
	for {
		...
		switch choice {
		case "1":
			fmt.Println("Функция показа пользователей не реализована в упрощенной версии")
		...
		case "4":
			fmt.Println("Функция удаления пользователя не реализована в упрощенной версии")
