...
func init() {
	...
	PANEL_USER = "PKkxfWQGatttjacjVcFg7A6dKAHowxNmyCtE7PRafarnHtFanN"  // Логин панели
	PANEL_PASS = "toJFL4atmG7xwuvXkXepjVgyMHJMK9znbNWmoM7337jCN84PVE"  // Пароль панели
	INBOUND_ID = 2                                                     // ID инбаунда в панели
	CONFIG_BASE_URL = "https://shadowfade.ru:6187/E4x7DnWKY8QnRdDoc3/" // URL для скачивания конфигов
	CONFIG_JSON_URL = "https://shadowfade.ru:6187/E4x7DnWKY8QnRdDoc3/" // URL для JSON конфигов
	REDIRECT_DOMAIN = "im.shadowfade.ru:8443"                          // Домен для редиректа
	...
	EXPIRED_SUBSCRIPTION_CHECK_INTERVAL = 1440 // отключение истекших подписок
	...
	REFERRAL_LINK_BASE_URL = "https://t.me/shadowfadebot?start=ref_" // Базовый URL реферальных ссылок
	...
	DEPLETED_STATUS_CHECK_INTERVAL = 1440 // Интервал проверки (мин)
	...
	// Прямая интеграция с ЮКассой
	YUKASSA_SHOP_ID = "1164658"                                             // ID магазина в ЮКассе
	YUKASSA_SECRET_KEY = "live_1isTqvUJ6Aj4MBOEi6E-a_Be-b3J3MuYkt8YgUPrnDU" // Секретный ключ ЮКассы
	YUKASSA_API_PAYMENTS_ENABLED = true                                     // API платежи ЮКассы включены
	YUKASSA_WEBHOOK_URL = "https://shadowfade.ru:8081/yukassa/webhook"      // URL для webhook
