...
func init() {
	...
	CONFIG_JSON_URL = "https://st.акуавпн.рф:3052/KspXCja9H4JyBFs/"

	REDIRECT_DOMAIN = "st.акуавпн.рф:8081" // редирект для импорта подписки
	...
	YUKASSA_PROVIDER_TOKEN = "381764678:TEST:141303" // Токен от BotFather
	TELEGRAM_PAYMENTS_ENABLED = false                // Отключить платежи через Telegram

	// === ПРЯМОЕ API ЮКАССЫ ===
	// Использует прямую интеграцию с API ЮКассы
	YUKASSA_SHOP_ID = "1151760"                                             // ID магазина ЮКассы
	YUKASSA_SECRET_KEY = "live_yS5yDHJ5aHZjhnOxnbmVWrNQJsiU_6xJVwi1TJlzIwY" // Секретный ключ ЮКассы
	YUKASSA_API_PAYMENTS_ENABLED = true                                     // Включить платежи через прямое API
	YUKASSA_WEBHOOK_URL = "https://st.акуавпн.рф:8081/yukassa/webhook"      // URL для уведомлений от ЮКассы
